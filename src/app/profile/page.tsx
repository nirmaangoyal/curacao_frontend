...
export const metadata: Metadata = {
  title: "Next.js Profile | CuracaoAdmin - Next.js Dashboard Template",
  description:
    "This is Next.js Profile page for CuracaoAdmin - Next.js Tailwind CSS Admin Dashboard Template",
};
