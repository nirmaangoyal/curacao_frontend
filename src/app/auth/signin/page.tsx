...
export const metadata: Metadata = {
  title: "Next.js SignIn Page | CuracaoAdmin - Next.js Dashboard Template",
  description: "This is Next.js Signin Page CuracaoAdmin Dashboard Template",
};
