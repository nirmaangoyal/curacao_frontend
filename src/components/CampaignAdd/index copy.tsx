...
import DatePickerTwo from "@/components/CampaignAdd/DatePicker/DatePickerTwo";
import DatePickerOne from "@/components/CampaignAdd/DatePicker/DatePickerOne";
import MultiSelect from "@/components/CampaignAdd/MultiSelect";
import CampaignTypes from "@/components/CampaignAdd/CampaignTypes";
...
const CampaignAdd = () => {
  return (
    <>
      ...
      <div className="grid grid-cols-1 gap-9 sm:grid-cols-campaign">
            ...
            <div className="flex flex-col gap-5.5 p-6.5">
              <div>
                <label className="mb-3 block text-sm font-medium text-black dark:text-white">
                  Campaign Name <span class="red">*</span>
                </label>
                <input
                  type="text"
              ...
              <div>
                <label className="mb-3 block text-sm font-medium text-black dark:text-white">
                  Campaign Description <span class="red">*</span>
                </label>
                <textarea
                  rows={3}
              ...
              <div>
                <label className="mb-3 block text-sm font-medium text-black dark:text-white">
                  Overall Campaign Budget <span class="red">*</span>
                </label>
                <input
                  type="text"
                  placeholder="Budget"
        ...
        <div className="flex flex-col gap-9">
          <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            <div className="border-b border-stroke px-6.5 py-4 dark:border-strokedark">
              <h3 className="font-medium text-black dark:text-white">
              Campaign Date <span class="red">*</span>
              </h3>
            </div>
            <div className="flex flex-col gap-5.5 p-6.5">
              <DatePickerOne />
