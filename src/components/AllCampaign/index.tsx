      ...
      <div className="flex flex-col gap-10">
          <div className="rounded-sm border border-stroke bg-white px-5 pb-6 pt-6 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5">
            <div className="flex flex-col">
              <div className="grid grid-cols-3 rounded-sm bg-gray-2 dark:bg-meta-4 sm:grid-cols-5 tab">
                <div className="p-2.5 xl:p-5">
                  <h5 className="text-sm font-medium  xsm:text-base"><CheckboxTwo /></h5>
                </div>
                ...
                <div className="hidden p-2.5 text-center sm:block xl:p-5">
                  <h5 className="text-sm font-medium uppercase xsm:text-base">Channels</h5>
                </div>
                <div className="hidden p-2.5 text-center sm:block xl:p-5">
              ...
              <div className="clist grid grid-cols-3 rounded-sm bg-gray-2 dark:bg-meta-4 sm:grid-cols-5 tab">
                <div className="p-2.5 xl:p-5">
                <CheckboxTwo />
                </div>
                <div className="p-2.5 text-center xl:p-5">
                  <h5 className="text-sm font-medium  xsm:text-base">Camapign Name</h5>
                </div>
                <div className="p-2.5 text-center xl:p-5">
                  <h5 className="text-sm font-medium  xsm:text-base">Camapign Description</h5>
                </div>
                <div className="hidden p-2.5 text-center sm:block xl:p-5">
                  <h5 className="text-sm font-medium  xsm:text-base">TV / OTT / SM</h5>
                </div>
                <div className="hidden p-2.5 text-center sm:block xl:p-5">
                  <h5 className="text-sm font-medium  xsm:text-base"><a href="#edit" className="edit">Edit</a> | <a href="#delete" className="delete">Delete</a></h5>
                </div>
              ...
              <div className="clist grid grid-cols-3 rounded-sm bg-gray-2 dark:bg-meta-4 sm:grid-cols-5 tab sub-campaigns">
                  <div className="p-2.5 xl:p-5">
                  <CheckboxTwo />
                  </div>
                  <div className="p-2.5 text-center xl:p-5">
                    <h5 className="text-sm font-medium xsm:text-base">Sub Campaign TV</h5>
                  </div>
                  <div className="p-2.5 text-center xl:p-5">
                    <h5 className="text-sm font-medium xsm:text-base">Camapign Description</h5>
                  </div>
                  <div className="hidden p-2.5 text-center sm:block xl:p-5">
                    <h5 className="text-sm font-medium  xsm:text-base">TV</h5>
                  </div>
                  <div className="hidden p-2.5 text-center sm:block xl:p-5">
                    <h5 className="text-sm font-medium  xsm:text-base"><a href="#edit" className="edit">Edit</a> | <a href="#delete" className="delete">Delete</a></h5>
                  </div>
                ...
                <div className="clist grid grid-cols-3 rounded-sm bg-gray-2 dark:bg-meta-4 sm:grid-cols-5 tab sub-campaigns">
                  ...
                  <div className="p-2.5 text-center xl:p-5">
                    <h5 className="text-sm font-medium  xsm:text-base">Sub Campaign Radio</h5>
                  </div>
                  <div className="p-2.5 text-center xl:p-5">
                    <h5 className="text-sm font-medium  xsm:text-base">Camapign Description</h5>
                  </div>
                  <div className="hidden p-2.5 text-center sm:block xl:p-5">
                    <h5 className="text-sm font-medium  xsm:text-base">Radio</h5>
                  </div>
                  <div className="hidden p-2.5 text-center sm:block xl:p-5">
                    <h5 className="text-sm font-medium  xsm:text-base"><a href="#edit" className="edit">Edit</a> | <a href="#delete" className="delete">Delete</a></h5>
                  </div>
                ...
                <div className="clist grid grid-cols-3 rounded-sm bg-gray-2 dark:bg-meta-4 sm:grid-cols-5 tab sub-campaigns">
                  ...
                  <div className="p-2.5 text-center xl:p-5">
                    <h5 className="text-sm font-medium  xsm:text-base">Sub Campaign SM</h5>
                  </div>
                  <div className="p-2.5 text-center xl:p-5">
                    <h5 className="text-sm font-medium  xsm:text-base">Camapign Description</h5>
                  </div>
                  <div className="hidden p-2.5 text-center sm:block xl:p-5">
                    <h5 className="text-sm font-medium  xsm:text-base">SM</h5>
                  </div>
                  <div className="hidden p-2.5 text-center sm:block xl:p-5">
                    <h5 className="text-sm font-medium  xsm:text-base"><a href="#edit" className="edit">Edit</a> | <a href="#delete" className="delete">Delete</a></h5>
                  </div>
              ...
              <div className="clist grid grid-cols-3 rounded-sm bg-gray-2 dark:bg-meta-4 sm:grid-cols-5 tab">
                ...
                <div className="p-2.5 text-center xl:p-5">
                  <h5 className="text-sm font-medium  xsm:text-base">Camapign Name 2</h5>
                </div>
                <div className="p-2.5 text-center xl:p-5">
                  <h5 className="text-sm font-medium  xsm:text-base">Camapign Description 2</h5>
                </div>
                <div className="hidden p-2.5 text-center sm:block xl:p-5">
                  <h5 className="text-sm font-medium  xsm:text-base">TV / OTT / SM / Radio</h5>
                </div>
                <div className="hidden p-2.5 text-center sm:block xl:p-5">
                  <h5 className="text-sm font-medium  xsm:text-base"><a href="#edit" className="edit">Edit</a> | <a href="#delete" className="delete">Delete</a></h5>
                </div>
